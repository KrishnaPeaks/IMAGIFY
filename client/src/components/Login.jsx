  ...
  return (
    ...
    <form className='relative bg-white p-10 rounded-xl text-slate-500'> 
        ...
        { state!='Login' && <div className='border px-6 py-2 flex items-center gap-2 rounded-full mt-5'>
            <img src={assets.profile_icon} width={24}   alt=""/>
        ...
        <p className='text-sm text-blue-600 my-4 cirsor-pointer'>Forgot password?</p>
        <button className='bg-blue-600 w-full text-white py-2 rounded-full '>{ state === 'Login'?'Login': 'CreateAccount'} </button>
